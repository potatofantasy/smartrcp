...
public class Win32Constant extends SWT {
	...
	public static final int DATE_YEARMONTH = 0x00000008; 
	...
	public static final int DTM_SETFORMAT = OS.IsUnicode ? DTM_FIRST + 50
			: DTM_FIRST + 5;
	...
	public static final int HDM_GETITEM = OS.IsUnicode ? HDM_GETITEMW
			: HDM_GETITEMA;
	...
	public static final int HDM_INSERTITEM = OS.IsUnicode ? HDM_INSERTITEMW
			: HDM_INSERTITEMA;
	...
	public static final int HDM_SETITEM = OS.IsUnicode ? HDM_SETITEMW
			: HDM_SETITEMA;
	...
	public static final int HDN_BEGINTRACK = OS.IsUnicode ? 0xfffffeba
			: 0xfffffece;
	...
	public static final int HDN_DIVIDERDBLCLICK = OS.IsUnicode ? HDN_DIVIDERDBLCLICKW
			: HDN_DIVIDERDBLCLICKA;

	public static final int HDN_ITEMCHANGED = OS.IsUnicode ? 0xfffffebf
			: 0xfffffed3;
	...
	public static final int HDN_ITEMDBLCLICK = OS.IsUnicode ? HDN_ITEMDBLCLICKW
			: HDN_ITEMDBLCLICKA;
	...
	public static final int LOCALE_RETURN_NUMBER = 0x20000000; 
		public static final int LOCALE_S1159 = 0x00000028;

	public static final int LOCALE_S2359 = 0x00000029;

	public static final int LOCALE_SDAYNAME1 = 0x0000002A; 
		public static final int LOCALE_SDAYNAME2 = 0x0000002B; 
		public static final int LOCALE_SDAYNAME3 = 0x0000002C; 
		public static final int LOCALE_SDAYNAME4 = 0x0000002D; 
		public static final int LOCALE_SDAYNAME5 = 0x0000002E; 
		public static final int LOCALE_SDAYNAME6 = 0x0000002F; 
		public static final int LOCALE_SDAYNAME7 = 0x00000030; 
	...
	public static final int LOCALE_SMONTHNAME1 = 0x00000038; 
		public static final int LOCALE_SMONTHNAME10 = 0x00000041; 
		public static final int LOCALE_SMONTHNAME11 = 0x00000042; 
		public static final int LOCALE_SMONTHNAME12 = 0x00000043; 
		public static final int LOCALE_SMONTHNAME2 = 0x00000039; 
		public static final int LOCALE_SMONTHNAME3 = 0x0000003A; 
		public static final int LOCALE_SMONTHNAME4 = 0x0000003B; 
		public static final int LOCALE_SMONTHNAME5 = 0x0000003C; 
		public static final int LOCALE_SMONTHNAME6 = 0x0000003D; 
		public static final int LOCALE_SMONTHNAME7 = 0x0000003E; 
		public static final int LOCALE_SMONTHNAME8 = 0x0000003F; 
		public static final int LOCALE_SMONTHNAME9 = 0x00000040; 
	...
	public static final int LVM_GETCOLUMN = OS.IsUnicode ? 0x105f
			: 0x1019;
	...
	public static final int LVM_GETITEM = OS.IsUnicode ? 0x104b : 0x1005;
	...
	public static final int LVM_GETSTRINGWIDTH = OS.IsUnicode ? 0x1057
			: 0x1011;
	...
	public static final int LVM_INSERTCOLUMN = OS.IsUnicode ? 0x1061
			: 0x101b;

	public static final int LVM_INSERTITEM = OS.IsUnicode ? 0x104d
			: 0x1007;
	...
	public static final int LVM_SETCOLUMN = OS.IsUnicode ? 0x1060
			: 0x101a;
	...
	public static final int LVM_SETITEM = OS.IsUnicode ? 0x104c : 0x1006;
	...
	public static final int RB_GETBANDINFO = OS.IsUnicode ? 0x41c
			: 0x41d;
	...
	public static final int RB_INSERTBAND = OS.IsUnicode ? 0x40a : 0x401;

	public static final int RB_MOVEBAND = 0x427;

	public static final int RB_SETBANDINFO = OS.IsUnicode ? 0x40b
			: 0x406;
	...
	public static final int TB_ADDSTRING = OS.IsUnicode ? 0x44d : 0x41c;
	...
	public static final int TB_GETBUTTONINFO = OS.IsUnicode ? 0x43f
			: 0x441;

	public static final int TB_GETBUTTONSIZE = 0x43a;

	public static final int TB_GETBUTTONTEXT = OS.IsUnicode ? 0x44b
			: 0x42d;
	...
	public static final int TB_INSERTBUTTON = OS.IsUnicode ? 0x443
			: 0x415;

	public static final int TB_LOADIMAGES = 0x432;

	public static final int TB_MAPACCELERATOR = 0x0400 + (OS.IsUnicode ? 90
			: 78);

	public static final int TB_SETBITMAPSIZE = 0x420;

	public static final int TB_SETBUTTONINFO = OS.IsUnicode ? 0x440
			: 0x442;
	...
	public static final int TCM_INSERTITEM = OS.IsUnicode ? 0x133e
			: 0x1307;
	...
	public static final int TCM_SETITEM = OS.IsUnicode ? 0x133d : 0x1306;
	...
	public static final int TTM_ADDTOOL = OS.IsUnicode ? 0x432 : 0x404;

	public static final int TTM_ADJUSTRECT = 0x400 + 31;

	public static final int TTM_DELTOOL = OS.IsUnicode ? 0x433 : 0x405;

	public static final int TTM_GETCURRENTTOOL = 0x400 + (OS.IsUnicode ? 59
			: 15);
	...
	public static final int TTM_GETTOOLINFO = 0x400 + (OS.IsUnicode ? 53
			: 8);

	public static final int TTM_NEWTOOLRECT = 0x400 + (OS.IsUnicode ? 52
			: 6);
	...
	public static final int TTM_SETTITLE = 0x400 + (OS.IsUnicode ? 33
			: 32);
	...
	public static final int TTN_GETDISPINFO = OS.IsUnicode ? 0xfffffdee
			: 0xfffffdf8;
	...
	public static final int TVI_FIRST = -0x0FFFF;

	public static final int TVI_LAST = -0x0FFFE;

	public static final int TVI_ROOT = -0x10000;

	public static final int TVI_SORT = -0x0FFFD;
	...
	public static final int TVM_GETITEM = OS.IsUnicode ? 0x113e : 0x110c;
	...
	public static final int TVM_INSERTITEM = OS.IsUnicode ? 0x1132
			: 0x1100;
	...
	public static final int TVM_SETITEM = OS.IsUnicode ? 0x113f : 0x110d;
	...
	public static final int WS_MAXIMIZEBOX = OS.IsWinCE ? 0x20000
			: 0x10000;

	public static final int WS_MINIMIZE = 0x20000000;

	public static final int WS_MINIMIZEBOX = OS.IsWinCE ? 0x10000
			: 0x20000;

	public static final int WS_OVERLAPPED = OS.IsWinCE ? WS_BORDER
			| WS_CAPTION : 0x0;

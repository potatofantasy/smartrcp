...
public class PlatAppSearch extends ViewPart {
	public static final String ID="smartrcp.platform.views.PlatAppSearch";
	...
	public void createPartControl(Composite arg){
		...
		this.container=new FlashContainer(parent,"PlatAppSearch");
